...
export namespace Schemas {
    ...
    export interface v1alpha1ApplicationSetGenerator {
        ...
        plugin?: Schemas.v1alpha1PluginGenerator;
    ...
    export interface v1alpha1ApplicationSetSpec {
        ...
        ignoreApplicationDifferences?: Schemas.v1alpha1ApplicationSetResourceIgnoreDifferences[];
        preservedFields?: Schemas.v1alpha1ApplicationPreservedFields;
    ...
    export interface v1alpha1ApplicationSourceHelm {
         ...
         */
        values?: string;
        valuesObject?: Schemas.runtimeRawExtension;
    ...
    export interface v1alpha1ApplicationSourceKustomize {
        ...
        patches?: Schemas.v1alpha1KustomizePatch[];
        /** Replicas is a list of Kustomize Replicas override specifications */
        replicas?: Schemas.v1alpha1KustomizeReplica[];
    ...
    export interface v1alpha1KustomizePatch {
        ...
        patch?: string;
        path?: string;
        target?: Schemas.v1alpha1KustomizeSelector;
    }
    export interface v1alpha1KustomizeReplica {
        count?: Schemas.intstrIntOrString;
        /** Name of Deployment or StatefulSet */
        name?: string;
    }
    export interface v1alpha1KustomizeResId {
        gvk?: Schemas.v1alpha1KustomizeGvk;
        name?: string;
        namespace?: string;
    }
    export interface v1alpha1KustomizeSelector {
        ...
        resId?: Schemas.v1alpha1KustomizeResId;
    }
    ...
    export interface v1alpha1PluginGenerator {
        configMapRef?: Schemas.v1alpha1PluginConfigMapRef;
        input?: Schemas.v1alpha1PluginInput;
    ...
    export interface v1alpha1PullRequestGenerator {
        azuredevops?: Schemas.v1alpha1PullRequestGeneratorAzureDevOps;
        bitbucket?: Schemas.v1alpha1PullRequestGeneratorBitbucket;
    ...
    export interface v1alpha1PullRequestGeneratorBitbucket {
        ...
        bearerToken?: Schemas.v1alpha1BearerTokenBitbucketCloud;
    ...
    export type v1alpha1ResourceNode = Schemas.v1alpha1ResourceRef;
    export interface v1alpha1ResourceOverride {
        actions?: string;
        healthLua?: string;
        ignoreDifferences?: Schemas.v1alpha1OverrideIgnoreDiff;
        ignoreResourceUpdates?: Schemas.v1alpha1OverrideIgnoreDiff;
    ...
    export interface v1alpha1SCMProviderGenerator {
        awsCodeCommit?: Schemas.v1alpha1SCMProviderGeneratorAWSCodeCommit;
    ...
    export interface v1alpha1SCMProviderGeneratorAWSCodeCommit {
        ...
        tagFilters?: Schemas.v1alpha1TagFilter[];
    }
...
export interface Parameter$ApplicationService_RevisionChartDetails {
    /** the application's name */
    name: string;
...
export interface Response$ApplicationService_RevisionChartDetails$Status$200 {
    "application/json": Schemas.v1alpha1ChartDetails;
}
export interface Response$ApplicationService_RevisionChartDetails$Status$default {
    "application/json": Schemas.runtimeError;
}
...
export type ResponseContentType$ApplicationService_RevisionChartDetails = keyof Response$ApplicationService_RevisionChartDetails$Status$200;
export interface Params$ApplicationService_RevisionChartDetails {
    parameter: Parameter$ApplicationService_RevisionChartDetails;
}
...
export namespace ErrorResponse {
    ...
    export type ApplicationService_RevisionChartDetails = void;
...
export class Client<RequestOption> {
     ...
     * Request URI: /api/v1/applications/{name}/revisions/{revision}/chartdetails
     */
    public async ApplicationService_RevisionChartDetails(params: Params$ApplicationService_RevisionChartDetails, option?: RequestOption): Promise<Response$ApplicationService_RevisionChartDetails$Status$200["application/json"]> {
        const url = this.baseUrl + `/api/v1/applications/${params.parameter.name}/revisions/${params.parameter.revision}/chartdetails`;
        const headers = {
            Accept: "application/json"
        };
        const queryParameters: QueryParameters = {
    ...
    public async ApplicationSetService_List(params: Params$ApplicationSetService_List, option?: RequestOption): Promise<Response$ApplicationSetService_List$Status$200["application/json"]> {
        ...
        const queryParameters: QueryParameters = {
            projects: { value: params.parameter.projects, explode: true },
            selector: { value: params.parameter.selector, explode: false },
            appsetNamespace: { value: params.parameter.appsetNamespace, explode: false }
        };
        return this.apiClient.request({
            httpMethod: "GET",
            url,
